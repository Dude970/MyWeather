...
import com.example.myweather.data.forecastModels.ForecastData
import com.example.myweather.databinding.ActivityMainBinding
import com.example.myweather.databinding.BottomSheetLayoutBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private var city: String = "hyderabad"
    ...
    private fun getForecast() {
        GlobalScope.launch(Dispatchers.IO) {
            ...
            if (response.isSuccessful && response.body() != null) {
                ...
                Log.e("TAG","error while getting data due to low internet connection.")
            }
        }
    }
